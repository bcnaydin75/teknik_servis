...
export default function AdminMobileNav({ onOpenMenu }: AdminMobileNavProps) {
  ...
  const nav = (
    <nav
      className={`admin-mobile-nav fixed inset-x-0 bottom-0 z-[60] border-t pb-[env(safe-area-inset-bottom,0px)] backdrop-blur-lg lg:hidden ${
        isDark
          ? "admin-dark border-slate-800 bg-slate-900/95"
